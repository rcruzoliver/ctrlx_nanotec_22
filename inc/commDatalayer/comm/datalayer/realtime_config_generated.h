...
struct NTelBufferConfig FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  bool mutate_defaultN(uint16_t _defaultN = 6) {
    return SetField<uint16_t>(VT_DEFAULTN, _defaultN, 6);
  }
  bool Verify(::flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           VerifyField<uint16_t>(verifier, VT_DEFAULTN, 2) &&
           verifier.EndTable();
  }
...
struct RealtimeConfigT : public ::flatbuffers::NativeTable {
  ...
  RealtimeConfigT() = default;
  RealtimeConfigT(const RealtimeConfigT &o);
  RealtimeConfigT(RealtimeConfigT&&) FLATBUFFERS_NOEXCEPT = default;
  RealtimeConfigT &operator=(RealtimeConfigT o) FLATBUFFERS_NOEXCEPT;
};
...
struct RealtimeConfig FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  bool mutate_defaultInputAcessType(comm::datalayer::AccessType _defaultInputAcessType = static_cast<comm::datalayer::AccessType>(2)) {
  ...
  bool Verify(::flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           VerifyField<int8_t>(verifier, VT_DEFAULTINPUTACESSTYPE, 1) &&
...
inline RealtimeConfigT::RealtimeConfigT(const RealtimeConfigT &o)
      : defaultInputAcessType(o.defaultInputAcessType),
        nTelBufConfig((o.nTelBufConfig) ? new comm::datalayer::NTelBufferConfigT(*o.nTelBufConfig) : nullptr) {
}

inline RealtimeConfigT &RealtimeConfigT::operator=(RealtimeConfigT o) FLATBUFFERS_NOEXCEPT {
  std::swap(defaultInputAcessType, o.defaultInputAcessType);
  std::swap(nTelBufConfig, o.nTelBufConfig);
  return *this;
}
...
inline void RealtimeConfig::UnPackTo(RealtimeConfigT *_o, const ::flatbuffers::resolver_function_t *_resolver) const {
  ...
  { auto _e = nTelBufConfig(); if (_e) { if(_o->nTelBufConfig) { _e->UnPackTo(_o->nTelBufConfig.get(), _resolver); } else { _o->nTelBufConfig = std::unique_ptr<comm::datalayer::NTelBufferConfigT>(_e->UnPack(_resolver)); } } else if (_o->nTelBufConfig) { _o->nTelBufConfig.reset(); } }
}
...
inline comm::datalayer::RealtimeConfig *GetMutableSizePrefixedRealtimeConfig(void *buf) {
  return ::flatbuffers::GetMutableSizePrefixedRoot<comm::datalayer::RealtimeConfig>(buf);
}
